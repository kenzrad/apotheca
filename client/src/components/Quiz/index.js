...
class Quiz extends Component {
    optionClickHandler = e => {
        ...
        let currQuestion = e.currentTarget.getAttribute("data-question") - 1;
    ...
    render() {
        return (
            <>
                ...
                <div className="options" data-question="1" onClick={this.optionClickHandler}>
                ...
                <div className="options" data-question="2" onClick={this.optionClickHandler}>
                ...
                <div className="options" data-question="3" onClick={this.optionClickHandler}>
