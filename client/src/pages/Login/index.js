      ...
      <div className="login-backdrop">
        ...
        <div id="loginAndSignup">
          ...
          <div className="quizDiv hidden">
            ...
            <div className="chevrons">
              <button title="Go back" onClick={e => { this.moveLeft(e, 1) }}><i className="fas fa-chevron-left chevron"></i></button>
              <button title="Submit" type="submit" className="login-link" onClick={this.finalizeSignup}>Submit</button>
            </div>
          </div>
        </div>
        {/* MODALS */}
