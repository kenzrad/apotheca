...
const componentSeed = [
  {
    ...
    component: "Vitamin C",
    description:
      "a key ingredient found in many anti-aging skin care products, due to it’s cancer-fight antioxidant properties and its role in collagen production. Vitamin C is found at  high levels in the epidermis and the dermis layers of the skin. This vitamin can aid the treatment of dry skin, redness and irritation, wrinkles, and age spots.",
  ...
  },
  {
    ...
    component: "Vitamin K",
    description:
      "this vitamin is known to help reduce scaring, dark spots, and help alleviate dark circles under your eyes. Vitamin K strengthens capillaries, increases circulation, and reduces fluid retention to brighten and rejuvenate skin. This will strengthen and increase skin resiliency.",
    source:
  ...
  },
  {
    ...
    description:
      "also known as riboflavin, aids in healthy cell turnover which leads to bright, radiating, healthy, glowing skin. Riboflavin is important to those who are prone to acne. It helps maintain the mucus secretion of the skin to prevent acne breakouts and dry skin.",
  ...
  },
  {
    ...
    description:
      "also known as Niacin. This helps treat rosacea, acne. Eczema, hyperpigmentation, aging and dry skin. B3 can improve the appearance of the completion by softening and smoothing the skin, to reduce the looks of redness and wrinkles.",
    source: "https://www.skinstore.com/blog/skincare/b-vitamins/"
  },
  {
    id: 8,
    ...
    description:
      "also known as Pyridoxine, can aid in balancing the skin to reduce and prevent acne breakouts.",
    source: "https://www.skinstore.com/blog/skincare/b-vitamins/"
  },
  {
    id: 9,
    ...
    description:
      "also known as Biotin, this revitalizes the skin and evens out the complexion while combatting the harmful effects of free radicals. This will help maintain the skin’s production of fats to help plump, and hydrate the complexion and reduce signs of premature aging. Also good for fighting inflammation and side effects of skin conditions. ",
    source: "https://www.skinstore.com/blog/skincare/b-vitamins/"
  },
  {
    id: 10,
    ...
    description:
      "also known as Folic Acid, essential vitamin for cell production and tissue growth. This ensures healthy, radiant skin. This reduces the occurrence of breakouts and contributes to glowing, healthy skin that looks clear, plump, and radiant.",
    source: "https://www.skinstore.com/blog/skincare/b-vitamins/"
  },
  {
    id: 11,
    ...
    description:
      "also known as Cobalamin. This regulates the pigmentation of skin and can prevent dark spots. Can assist body the growth of healthy cells and can repair damaged skin.",
    source: "https://www.skinstore.com/blog/skincare/b-vitamins/"
  },
  {
    id: 12,
    component: "Potassium",
    description:
      "although potassium cannot be absorbed through your skin, it can enhance the moisture and improve the feel and complexion of your skin. Potassium can be found in many skin care products to help adjust and balance pH, and help aid in moisturizing the skin.",
    source:
  ...
  },
  {
    ...
    component: "Zinc",
    description:
      "zinc is known to be a powerful protectant again sun’s UV light. Unlike other chemical sunscreen ingredients that absorb into the skin, Zinc can help create a layer that stops UV light from penetrating your skin altogether. It is also great for reducing inflammation and soothe irritated skin. It’s an anti-microbial which can regulate immunity and stimulate the production of new cells.",
  ...
  },
  {
    ...
    component: "Magnesium",
    description:
      "This component can improve the skin’s overall appearance by balancing the production of sebum, which is can cause oil build up linked to acne and other irritants. It can also even out the skin tone for those who suffer from Rosacea, or other skin conditions.",
    source:
  ...
  },
  {
    ...
    description:
      "This component has been known to treat rosacea, reduce inflammation and oxidative stress. Flavonoids absorb UV light and can influence cellular functions to prevent photoaging and damage. This can help in stimulation of collagen, which will delay aging.",
    source: "https://www.dermstore.com/blog/top_ten/antioxidants-in-skin-care/"
  },
  {
    id: 18,
    ...
    description:
      "This is an antimicrobial component that can protect skin from pollution, infection, and UV damage. This antioxidant can boost the activity of mitochondria in the cells which will promote longer cell life. This keeps skin youthful and fresh looking.",
    source: "https://www.dermstore.com/blog/top_ten/antioxidants-in-skin-care/"
  },
  {
    id: 19,
  ...
  },
  {
    ...
    component: "Proteins",
    description:
      "when applied topically stimulate formation of collagen and elastin and promote cell renewal.Glutamine regulates acid-base balance and helps make the skin firm.",
    source:
  ...
  },
  {
    ...
    component: "Papain",
    description:
      "this is an enzyme that is very effective in skin renewal and skin lightening. It can also function as an exfoliator, skin softener, and moisturizer. This can remove dead skin cells and plump the skin to fight acne and combat free radicals, thus preventing premature aging.",
  ...
  },
  {
    ...
    description:
      "serves as an active therapeutic agent in treatment of several microbicidal disorders. This can help aid the treatment of acne.",
  ...
  },
  {
    ...
    component: "EGCG",
    description:
      "is a powerful antioxidant that has major free radical fighting abilities. It is given to be more potent than vitamin A and C. by neutralizing free radicals that are produced by UV light, this component can prevent DNA damage and harmful tumor formations. It also helps our bodies produce more interleukin which is a natural growth factor that repairs damage skin.",
  ...
  },
  {
    ...
    component: "Tulsi",
    description:
      "This component can be used to purify and cleanse the skin due to its detoxifying properties. It is known to soothe inflammation, help treat acne and scars, skin infections, lighten dark spots, and improve skins texture.",
    source:
  ...
  },
  {
    ...
    component: "Lycopene",
    description:
      "this component is known for it’s ability to combat acne. It is a powerful antioxidant and anti-inflammatory that helps protect skin from environmental agents that can contribute to clogged pores and breakouts.",
  ...
  },
  {
    ...
    component: "Vitamin D",
    description:
      "also known as calcitriol, contributes to skin cell growth, repair, and metabolism. It optimizes the skin’s immune system and helps destroy free radicals that can cause premature aging.",
    source:
  ...
  },
  {
    ...
    description:
      "also known as vitamin B9, plays a vital role in helping to maintain the skin’s natural beauty. May also provide increased hydration by bolstering skin - barrier function.This can improve moisture - retention and alleviate skin dryness",
  ...
  },
  {
    ...
    component: "caffeine",
    description:
      "caffeine in skin products claims that it will improve the look of cellulite or puffy eyes. Applied to skin, caffeine may have soothing and antioxidant properties, especially when skin is exposed to UV light",
    source:
  ...
  },
  {
    ...
    description:
      "is a godsend for dry, aging skin since it penetrates easily and deeply into the skin’s surface, replenishing lost moisture that naturally comes with age, also helps the moisture from evaporating.",
    source:
  ...
  },
  {
    ...
    description:
      "helps makes the skin’s barrier stronger so it can effectively keep water in and irritants out.Topical use can also help reduce acne breakouts.",
  ...
  },
  {
    ...
    description:
      "it is an antifungal agent, antiviral, astringent and antioxidant. Some studies have indicated that it has anticancer activity and that it can relax blood vessels.",
  ...
  },
  {
    ...
    description:
      "has been shown to be effective in inhibiting bacterial growth and destroying bacterial biofilms",
  ...
  },
  {
    ...
    component: "limonene",
    description:
      "Like most volatile fragrance components, limonene also has strong antioxidant benefits and has also been shown to calm skin",
    source:
      "https://www.paulaschoice.com/ingredient-dictionary/fragrance-synthetic-and-fragrant-plant-extracts/limonene.html"
  },
  {
    id: 41,
    component: "sodium bicarbonate",
    description:
      "can remove the skin's protective oil barrier, alter its pH, and disrupt the natural bacteria on the surface that help to prevent infection and acne",
    source: "https://www.healthline.com/health/baking-soda-for-face#1"
  },
  {
    id: 42,
    component: "lauric acid",
    description:
      "having antibacterial properties, it has been found to effectively combat acne. Lauric acid also could reduce inflammation and the number of bacteria present",
    source:
