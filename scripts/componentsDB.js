...
const componentSeed = [
  ...
  },
  {
    ...
    component: "Vitamin E",
    description:
      "Vitamin E is an antioxidant which largely helps protect the skin against harmful UV radiation. It does this through by contributing to 'photo-protection', which refers to the ability of the body to reduce sun damage. Protection from sun damage is critical to anti-aging, preventing dark spots and wrinkles. The body naturally produces vitamin E through sebum, though sebum production is decreased in dry skin. Applying Vitamin E supplements to dry skin can counteract the lack of sebum and moisturize the skin. Vitamin E also helps combat skin inflammation and reduce scarring.",
    source: "https://www.healthline.com/health/4-best-vitamins-for-skin)"
  },
  {
    id: 3,
  ...
  },
  {
    ...
    description:
      "Vitamin B2 known as riboflavin, aids in healthy cell turnover which leads to bright, radiating, healthy, glowing skin. Riboflavin is important to those who are prone to acne. It helps maintain the mucus secretion of the skin to prevent acne breakouts and dry skin.",
  ...
  },
  {
    ...
    description:
      "Vitamin B3, or Niacin, helps treat rosacea and acne. Eczema, hyperpigmentation, aging and dry skin. B3 can improve the appearance of the completion by softening and smoothing the skin, to reduce the looks of redness and wrinkles.",
    source: "https://www.skinstore.com/blog/skincare/b-vitamins/"
  },
  {
    id: 8,
  ...
  },
  {
    ...
    description:
      "Vitamin B7, or Biotin, revitalizes the skin and evens out the complexion while combatting the harmful effects of free radicals. This will help maintain the skin’s production of fats to help plump, and hydrate the complexion and reduce signs of premature aging. Also good for fighting inflammation and side effects of skin conditions. ",
    source: "https://www.skinstore.com/blog/skincare/b-vitamins/"
  },
  {
    id: 10,
  ...
  },
  {
    ...
    description:
      "Vitamin B12, also known as Cobalamin, regulates the pigmentation of skin and can prevent dark spots. Can assist body the growth of healthy cells and can repair damaged skin.",
    source: "https://www.skinstore.com/blog/skincare/b-vitamins/"
  },
  {
    id: 12,
    component: "Potassium",
    description:
      "Potassium can be found in many skin care products to help adjust and balance pH, and help aid in moisturizing the skin. Although potassium cannot be absorbed through your skin, it can enhance the moisture and improve the feel and complexion of your skin. ",
    source:
  ...
  },
  {
    ...
    component: "Magnesium",
    description:
      "Magnesium can improve the skin’s overall appearance by balancing the production of sebum, which is can cause oil build up linked to acne and other irritants. It can also even out the skin tone for those who suffer from Rosacea, or other skin conditions.",
    source:
  ...
  },
  {
    id: 21,
    component: "Carotol",
    description: "Carotol is used to help brighten and rejuvenate the skin. The antioxidants in carotol repair the damages done to your tissues by oxidants (free radicals) and stop them from doing further harm. Additionally, carotol can aid in detox of the skin, liver, and kidneys.",
    source:
  ...
  },
  {
    ...
    component: "Proteins",
    description:
      "Certain proteins, when applied topically, can stimulate the formation of collagen and elastin and promote cell renewal. Glutamine regulates acid-base balance and helps make the skin firm.",
    source:
  ...
  },
  {
    ...
    description: "Proline, Leucine, and Glycine amino acids diminish look of fine lines and wrinkles.",
    source:
      "https://www.paulaschoice.com/expert-advice/skincare-advice/anti-aging-wrinkles/amino-acids-for-skin.html"
  },
  {
  ...
  },
  {
    ...
    component: "EGCG",
    description:
      "EGCG is a powerful antioxidant that has major free radical fighting abilities. It is given to be more potent than vitamin A and C. by neutralizing free radicals that are produced by UV light, this component can prevent DNA damage and harmful tumor formations. It also helps our bodies produce more interleukin which is a natural growth factor that repairs damage skin.",
  ...
  },
  {
    ...
    component: "Tulsi",
    description:
      "Tulsi can be used to purify and cleanse the skin due to its detoxifying properties. It is known to soothe inflammation, help treat acne and scars, skin infections, lighten dark spots, and improve skins texture.",
    source:
  ...
  },
  {
    ...
    component: "Vitamin D",
    description:
      "Vitamin D, also known as calcitriol, contributes to skin cell growth, repair, and metabolism. It optimizes the skin’s immune system and helps destroy free radicals that can cause premature aging.",
    source:
  ...
  },
  {
    id: 40,
    component: "Limonene",
    description: "Limonene has the ability to reduce inflammation through numerous mechanisms. One-way limonene reduces inflammation is through the inhibition of angiogenesis. Angiogenesis is the formation of new blood vessels, which is an inherent component of inflammation. Thus, by inhibiting this process, limonene can help to reduce inflammation and improve wound healing. Limonene has strong antioxidant benefits, which are able to limit oxidative damage cause by free radicals.",
    source: "https://thedermreview.com/limonene/"
  },
  {
    id: 41,
    component: "Sodium Bicarbonate",
    description: "Sodium Bicarbonate is alkaline in nature, so it balances the pH levels of your skin to make it glow with radiance. It also helps in exfoliating the dead skin cells to reveal new freshness. This can help reduce scarring cause by acne. It also has anti-inflammatory and antibacterial properties.",
  ...
  },
  {
    ...
    description:
      "Lauric Acid has antibacterial properties, it has been found to effectively combat acne. Lauric acid also could reduce inflammation and the number of bacteria present",
    source:
